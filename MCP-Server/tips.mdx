...
2. Create a new command file (e.g., `sdk-assistant.md`)
3. Copy the system prompt from the accordion above
4. Paste into your command file
5. Use the command by typing `/sdk-assistant` in Claude Code

**Example command file structure:**
```markdown
---
description: "Activate Sony Camera Remote SDK expert mode"
---
...
2. Click **Project Knowledge** → **Add Content** → **Custom Instructions**
3. Copy the system prompt from the accordion above
...
<Note>
For ChatGPT, you'll need to add the system prompt to each new conversation where you want to use it. Unlike Claude Projects, ChatGPT doesn't have persistent custom instructions per project.
</Note>
