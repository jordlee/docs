---
title: "Tips"
description: "Best practices for using AI SDK Assistant to learn and implement the Camera Remote SDK"
icon: "lightbulb"
---

## General Prompting Tips

Get better results from AI SDK Assistant by following these best practices when asking questions about the Camera Remote SDK.
...
AI SDK Assistant has access to working C++ and C# code examples from the SDK. Don't hesitate to request them.
...
AI SDK Assistant uses **13+ specialized search tools** to find the best answers for your questions. Your AI assistant automatically chooses the right tool based on what you're asking.
...
AI SDK Assistant can search across:
...
AI SDK Assistant currently searches **SDK V2.00.00** by default. If you need information from V1.14.00, just specify it in your question.
...
Ask AI SDK Assistant to show you how the official sample apps implement features:
...
<Tip>
  The more specific and detailed your questions, the better AI SDK Assistant can help you learn and implement the Camera Remote SDK!
</Tip>
