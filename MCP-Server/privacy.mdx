...
For example, in Claude Code, you have control over which directories in your filesystem Claude has access to, as well as the permission level.

![image.png](/images/image.png)

When prompting Claude, you can control how much autonomy it has when executing tasks. 
