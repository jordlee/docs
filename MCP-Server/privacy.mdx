...
When prompting Claude, you can control how much autonomy it has when executing tasks. By toggling through the options, you can ensure that Claude waits for approval before taking action. For more information on Anthropic's agentic modes, [view the offical site here.](https://claudelog.com/mechanics/plan-mode/)
...
<CardGroup cols={2}>
  ...
  <Card title="Contact Support" icon="envelope" href="mailto:jordan.lee@sony.com">
