...
When prompting Claude, you can control how much autonomy it has when executing tasks. By toggling through the options, you can ensure that Claude waits for approval before taking action. For more information on Anthropic's agentic modes, [view the official site here.](https://claudelog.com/mechanics/plan-mode/)
...
<CardGroup cols={2}>
  <Card icon="bug" href="https://sna-ipsa-developer-tools.atlassian.net/jira/software/form/68c76742-1683-4ac8-83f3-a2e2518e5ffc?atlOrigin=eyJpIjoiNTNmNWM0OWYxZTYyNGM2NWIzNTUwOWEzZGRjNmI1ZTIiLCJwIjoiaiJ9" title="Report Issues">
    Submit a bug report or privacy concern
  </Card>
  <Card icon="envelope" href="mailto:jordan.lee@sony.com" title="Contact Support">
...
<AccordionGroup>
  <Accordion icon="database" title="What data does AI SDK Assistant collect?">
  ...
  <Accordion icon="code" title="Is my code safe?">
  ...
  <Accordion icon="eye" title="Who can see my questions?">
  ...
  <Accordion icon="clock" title="How long is data retained?">
  ...
  <Accordion icon="building" title="Can I use this for commercial projects?">
