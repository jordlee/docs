---
title: "Tools"
description: "Comprehensive guide to the AI SDK Assistant's search and utility tools"
icon: "wrench"
---
...
<Note>
  You don't need to manually specify which tool to use—your AI assistant (Claude recommended) will automatically choose the most appropriate tool based on your query.
</Note>

<Warning>
  **ChatGPT Not Recommended**: Due to OpenAI's unofficial MCP support, ChatGPT cannot reliably access these tools and produces poor code generation. We strongly recommend using Claude for SDK development.
</Warning>
