---
title: "Tools"
description: "Comprehensive guide to Kando's search and utility tools"
icon: "wrench"
---

## Available Tools

Kando provides **13+ specialized tools** that your AI assistant can use to search SDK documentation, code examples, and technical references. Your AI automatically selects the best tool for your question, but understanding what's available helps you ask better questions.
...
**Use case**: Discover which versions Kando supports
...
**Use case**: Understand Kando's knowledge base scope
