...
<Tabs>
  <Tab title="Claude">
    ...
    2. **Configure Tools**
       ...
       AI SDK Assistant enables Claude to access SDK information through "Tools." These are specialized search methods and filters that influence what type of content is retrieved when you ask a question.
