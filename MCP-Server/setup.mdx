...
|--------|------|-------------|-----|
| **[Web API Docs](/MCP-Server/web-api-docs)** | `Kando` | Camera Remote Web API endpoints, Client SDK (TypeScript) | `https://crsdk.app/mcp` |
| **[SDK Docs](/MCP-Server/sdk-docs)** | `CRSDK` | Camera Remote SDK documentation, API references, and code examples (C++/C#) | `https://sdk-rag-agent-production.up.railway.app/mcp` |
| **[Help Guides](/MCP-Server/help-guides)** | `CameraAssistant` | Camera help guides, settings, and feature documentation for 24 Sony camera models | `https://camera-rag-agent-production.up.railway.app/mcp` |
...
<Tabs>
  <Tab title="Claude">
    ...
    1. **Add the Connector**
       ...
       - Name it using the server name from the table above (e.g. `Kando`, `CRSDK`, or `CameraAssistant`)
    ...
    2. **Configure Tools**
       ...
       Each server provides specialized search tools. Your AI automatically selects the best tool for your question. See the [Tools](/MCP-Server/tools) page for details.
  ...
  <Tab title="Claude Code">
    ...
    <Tabs>
      ...
      <Tab title="Windows (PowerShell or CMD)">
        ```bash
        # Web API Docs
        claude mcp add Kando --scope user -- cmd /c npx mcp-remote https://crsdk.app/mcp
    ...
    **Or approve specific tools only:**
    ...
    ```json
    {
      "approvedTools": [
        ...
        "mcp__CameraAssistant__search_camera",
        "mcp__CameraAssistant__search_help_guides",
        "mcp__CameraAssistant__search_topic"
      ]
    }
    ```
    ...
    claude mcp remove Kando --scope user             # Remove Web API Docs
    claude mcp remove CRSDK --scope user             # Remove SDK Docs
    claude mcp remove CameraAssistant --scope user   # Remove Help Guides
    ```
  ...
  <Tab title="Cursor">
    ...
    | Server | Name | Command |
    |--------|------|---------|
    | Web API Docs | `Kando` | `npx mcp-remote https://crsdk.app/mcp` |
    | SDK Docs | `CRSDK` | `npx mcp-remote https://sdk-rag-agent-production.up.railway.app/mcp` |
    | Help Guides | `CameraAssistant` | `npx mcp-remote https://camera-rag-agent-production.up.railway.app/mcp` |
