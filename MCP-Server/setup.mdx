...
<Warning>
  **Claude Recommended**: Due to OpenAI's unofficial support for MCP servers, ChatGPT has significant limitations with code generation and tool functionality. We strongly recommend using Claude for SDK development. Only use ChatGPT if you already have an active subscription and cannot access Claude.
</Warning>
  ...
  <Tab title="ChatGPT">
    <Warning>
      **Not Recommended Unless You Already Have a ChatGPT Subscription**
      ...
      Due to OpenAI's unofficial support for MCP servers, ChatGPT has significant limitations with the AI SDK Assistant:
      - Poor code generation (pseudo-code only, not production-ready SDK code)
      - Limited tool access and search capabilities
      - Cannot be used in ChatGPT Projects or Deep Research mode
      - Basic tool permissions (all or nothing)

      We strongly recommend using Claude instead for SDK development. Only use ChatGPT if you already have an active subscription and cannot access Claude.
    </Warning>
