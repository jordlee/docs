...
<CardGroup cols={2}>
  <Card title="Accurate SDK Information" icon="bullseye">
    Ensures AI always uses MCP tools instead of web search for SDK queries
  </Card>
  <Card title="Version-Aware Responses" icon="code-branch">
    Confirms SDK version and programming language before answering
  </Card>
  <Card title="Production-Ready Code" icon="file-code">
    Generates complete, compilable code with proper error handling and citations
  </Card>
  <Card title="C# Support" icon="hashtag">
    Automatically retrieves C#-specific implementations for C# developers
  </Card>
</CardGroup>
...
<Warning>
ChatGPT has limited MCP support and may still prefer web search. The system prompt helps but isn't perfect.
</Warning>
