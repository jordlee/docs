...
<Card title="Quick Setup" icon="rocket" href="/quickstarts/mcp-server">
  Get AI SDK Assistant running in under 5 minutes
</Card>
...
- Ask your AI assistant (Claude recommended) about the Camera Remote SDK
...
- Searches across 13,333+ pieces of content including guides, API references, and code examples
- Works with SDK V2.01.00 (latest) and V2.00.00
...
Switch between SDK versions (V2.01.00 and V2.00.00) to find information for the version you're using.

### Use With Your Preferred AI Tool

Works with Claude (web, mobile, desktop, CLI), Cursor, and other AI assistants that support MCP (Model Context Protocol).
