...
Kando is an intelligent search assistant that helps developers learn and use Sony's Camera Remote SDK faster. Instead of manually searching through hundreds of pages of documentation, you can ask questions in plain English to AI assistants like Claude or ChatGPT, and get instant answers with code examples.
...
Kando works in three simple steps:

**1. You Ask a Question**
- Ask your AI assistant (Claude, ChatGPT, etc.) about the Camera Remote SDK
- Examples: "How do I connect to a camera?" or "Show me how to capture an image in C#"

**2. Kando Searches for Answers**
- The AI assistant automatically uses Kando to search through SDK documentation
...
## What Makes Kando Different?

### Smart Search
Kando understands what you're asking for, even if you don't know the exact API name. It uses AI to interpret your question and find the most relevant answers.
...
- **MCP (Model Context Protocol)**: The standard that lets AI assistants connect to Kando
- **Cloud Hosted**: Runs on Railway for reliable 24/7 availability

You don't need to understand these technologies to use Kando—just connect it to your AI assistant and start asking questions!