...
|--------|------|---------|-----|
| [Web API Docs](/MCP-Server/web-api-docs) | `CameraWebAPI` | HTTP endpoints, TypeScript Client SDK | `https://crsdk.app/mcp` |
| [SDK Docs](/MCP-Server/sdk-docs) | `CameraRemoteSDK` | C++/C# SDK docs, 13,000+ indexed pieces | `https://sdk-rag-agent-production.up.railway.app/mcp` |
| [Help Guides](/MCP-Server/help-guides) | `CameraHelp` | 24 camera models, 55,000+ help entries | `https://camera-rag-agent-production.up.railway.app/mcp` |
