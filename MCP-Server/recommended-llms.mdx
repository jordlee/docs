...
| **Claude Code (CLI)**           | Included with paid Claude account  | 200K tokens    | ✅ Granular file-based config<br />Approve server or specific tools | Good, smaller context window and no codebase access.      | Local configs<br />No additional data retention | Developers, automation workflows |
