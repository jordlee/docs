---
title: "Overview"
description: "TypeScript Client SDK (camera-remote-web-api) for controlling Sony cameras — CameraManager, BoundCamera, EventStream, automatic discovery, connection, and reconnection"
seo:
  title: "Client SDK Overview — TypeScript Camera Control"
  description: "camera-remote-web-api TypeScript SDK for Sony camera control. CameraManager handles discovery, connection, reconnection. BoundCamera accessor for typed camera operations."
---
