---
title: "Events"
description: "Client SDK SSE events — manager.on() for connection lifecycle, manager.camera(id).events for per-camera propertyChanged, downloadComplete, warning, afStatus, transferProgress"
seo:
  title: "SDK Events — SSE, Connection Lifecycle, Camera Notifications"
  description: "TypeScript Client SDK events: manager.on() for camera-ready/camera-found/camera-disconnected, cam.events.on() for propertyChanged, downloadComplete, warning, afStatus, transferProgress, once() one-shot listeners."
---
