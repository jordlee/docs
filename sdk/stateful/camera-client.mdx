---
title: "CameraClient"
description: "TypeScript CameraClient — typed HTTP client for all Camera Remote Web API endpoints: getProperty, setProperty, triggerShutter, afShutter, focusNearFar, controlZoom, listSDCardFiles, live view"
seo:
  title: "CameraClient — Typed HTTP Client for Camera API"
  description: "CameraClient provides typed methods for every Camera Remote Web API endpoint: properties, shutter, focus, zoom, live view, SD card, settings. Used internally by CameraManager."
---
