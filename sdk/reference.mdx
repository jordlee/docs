---
title: "Setup"
description: "Install camera-remote-web-api TypeScript Client SDK, configure platform binaries (macOS, Linux, Windows), CLI commands (camera-server), MCP server install, auth login"
seo:
  title: "SDK Setup — Install, Platform Binaries, CLI Reference"
  description: "Install camera-remote-web-api npm package, platform binaries for macOS/Linux/Windows, camera-server CLI commands: info, doctor, platforms, mcp install, auth login/logout."
---
